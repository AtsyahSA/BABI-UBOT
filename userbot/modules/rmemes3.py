...
async def _(event):
    ...
    if input_str == "owner":
        ...
        animation_chars = [
            "**COWNER SULAWESI KERAS ADALAH MANUSIA TERGANTENG DI HATI MEMBERNYA, KENALAN DULU SAMA OWNER NYA YUK**"
            "**ASA NAMANYA,ORANG NYA BAIK**"
            "**TINGGAL NYA DI JOGJA, BTW ORANG JOGJA GANTENG GANTENG DAN THEBEST POKOK NYA AWWHHHH**"
            "**KALO MAU JOIN,TINGGAL PENCET BIONYA YAAA GANTENG/CANTIK**"
            "**POKOK NYA OWNER DAN COWNER NYA THEBEST BANGET SERIUSSSSS**"
            "**UDAH POKOK NYA ITU AJA SIH,INTINYA COWNER NYA GANTENG DAN BAIK PARAH**"]
